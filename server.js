        ...
        .on('response', function(response){
            response.pipe(zlib.createGunzip())
               ...
               .on('data',function(ev){
                   ...
                   var e = {"created_at": ev.created_at, "location": (ev.actor_attributes ? ev.actor_attributes.location : "undefined"), "repo": (ev.repository ? ev.repository.name : "undefined"), "type": ev.type, "url": ev.url, "actor": ev.actor, "payloadsize": (ev.payload && ev.payload.size ? ev.payload.size : 0)};
