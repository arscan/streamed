...
var createWebServer = function(defaultDomain, port, config){
    ...
    var server = http.createServer(function(req, res) {
        ...
        } else if (streams[parts[0]] && parts.length === 2 && parts[1].indexOf("streamserver") !== 0 && parts[1].indexOf("favicon.ico") !== 0){
            // has the streamid, and a file to read within it
            // ignore streamserver.vX.js
            // I probably should do something smarter here
            // TODO: add test for custom domains and static files
            stream = streams[parts[0]];
